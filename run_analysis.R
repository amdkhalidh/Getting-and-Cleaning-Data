...
setwd("C:/Users/khalidm/Documents/UCI HAR Dataset/") 												##setting working directory

X_test <- read.table("C:/Users/khalidm/Documents/UCI HAR Dataset/test/X_test.txt") 					##reading X_test to X_test data frame
X_train <- read.table("C:/Users/khalidm/Documents/UCI HAR Dataset/train/X_train.txt") 				##reading X_train to X_train data frame

Y_test <- read.table("C:/Users/khalidm/Documents/UCI HAR Dataset/test/Y_test.txt") 					##reading Y_test to Y_test data frame
Y_train <- read.table("C:/Users/khalidm/Documents/UCI HAR Dataset/train/Y_train.txt") 				##reading Y_train to Y_train data frame

subject_test <- read.table("C:/Users/khalidm/Documents/UCI HAR Dataset/test/subject_test.txt") 		##reading subject_test to subject_test data frame
subject_train <- read.table("C:/Users/khalidm/Documents/UCI HAR Dataset/train/subject_train.txt") 	##reading subject_train to subject_train data frame

features<-read.table("C:/Users/khalidm/Documents/UCI HAR Dataset/features.txt") 					##reading features to features data frame
